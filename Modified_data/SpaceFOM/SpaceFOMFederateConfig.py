...
class SpaceFOMFederateConfig(TrickHLAFederateConfig):
   ...
   def set_master_role( self, master_state = True ):
      ...
      if self.initialized :
         print 'Warning: SpaceFOMFederateConfig already initialized, set master ignored!'
      else:
   ...
   def set_pacing_role( self, pacing_state = True ):
      ...
      if self.initialized :
         print 'Warning: SpaceFOMFederateConfig already initialized, set pacing ignored!'
      else:
   ...
   def set_RRFP_role( self, RRFP_state = True ):
      ...
      if self.initialized :
         print 'Warning: SpaceFOMFederateConfig already initialized, set RRFP ignored!'
      else:
   ...
   def set_config_S_define_name( self, config_S_define_name ):
      ...
      # You can only change RRFP state before initialize method is called.
      if self.initialized :
         print 'Warning: SpaceFOMFederateConfig already initialized, set ExCO SimObject name ignored!'
      else:
   ...
   def set_scenario_timeline_epoch( self, epoch ):
      ...
      if self.initialized :
         print 'Warning: SpaceFOMFederateConfig already initialized, set scenario time epoch ignored!'
         return
   ...
   def initialize( self ):
      ...
      if self.initialized :
         print 'Warning: SpaceFOMFederateConfig already initialized!  Ignored!'
         return
