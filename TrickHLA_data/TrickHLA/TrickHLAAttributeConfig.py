...
#     ((Dan Dexter) (NASA/ER6) (Sept 2025) (--) (Added preferred order support.)))
##############################################################################
import trick
...
class TrickHLAAttributeConfig( TrickHLARecordElementConfig ):
   ...
   preferred_order = trick.TrickHLA.TRANSPORT_SPECIFIED_IN_FOM
   ...
   def initialize( self, attribute ):
      ...
      attribute.preferred_order = self.preferred_order
