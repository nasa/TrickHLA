...
class JEODRefFrameTreeObject():
   ...
   def __init__( self,
      ...
      ssbary_frame_obj = SpaceFOMRefFrameObject(
                           create_frame_object          = create_frame_objects,
      ...
      sun_frame_obj = SpaceFOMRefFrameObject(
                           create_frame_object          = create_frame_objects,
      ...
      embary_frame_obj = SpaceFOMRefFrameObject(
                           create_frame_object          = create_frame_objects,
      ...
      earth_frame_obj = SpaceFOMRefFrameObject(
                           create_frame_object          = create_frame_objects,
      ...
      moon_frame_obj = SpaceFOMRefFrameObject(
                           create_frame_object          = create_frame_objects,
      ...
      mars_frame_obj = SpaceFOMRefFrameObject(
                           create_frame_object          = create_frame_objects,
      ...
      earth_pfix_frame_obj = SpaceFOMRefFrameObject(
                           create_frame_object          = create_frame_objects,
      ...
      moon_pfix_frame_obj = SpaceFOMRefFrameObject(
                           create_frame_object          = create_frame_objects,
      ...
      mars_pfix_frame_obj = SpaceFOMRefFrameObject(
                           create_frame_object          = create_frame_objects,
