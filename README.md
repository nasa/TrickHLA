...
[Example simulations](./sims/README.md) are provided for the SpaceFOM, TrickHLA, and IMSim Execution Control schemes. An example simulation for the Distributed Interface is also provided.
...
## Copyright:
Copyright 2020-2026 United States Government as represented by the Administrator of the National Aeronautics and Space Administration. No copyright is claimed in the United States under Title 17, U.S. Code. All Other Rights Reserved.
