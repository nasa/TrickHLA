...
typedef enum {
   ...
   DEBUG_SOURCE_TIME_MANAGEMENT    = 0x00004000, ///< Adds Time Management Services debug messages
   DEBUG_SOURCE_SAVE_RESTORE       = 0x00008000, ///< Adds Save and Restore Services debug messages
   DEBUG_SOURCE_HLA_ENCODERS       = 0x00010000, ///< Adds HLA Encoders (and subclass) debug messages
