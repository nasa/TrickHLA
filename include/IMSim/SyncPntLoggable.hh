...
#ifndef IMSIM_SYNC_PNT_LOGGABLE_HH
#define IMSIM_SYNC_PNT_LOGGABLE_HH
...
class SyncPntLoggable
{
   ...
   friend void init_attrIMSim__SyncPntLoggable();

  public:
   /*! @brief Default constructor for the TrickHLA SyncPntLoggable class. */
   SyncPntLoggable() : label( NULL ), state( TrickHLA::SYNC_PT_STATE_UNKNOWN )
   {
      return;
   }
...
#endif /* IMSIM_SYNC_PNT_LOGGABLE_HH */
