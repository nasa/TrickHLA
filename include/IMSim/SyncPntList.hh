...
#ifndef IMSIM_SYNC_PNT_LIST_HH
#define IMSIM_SYNC_PNT_LIST_HH
...
class SyncPntList : public TrickHLA::SyncPntListBase
{
   ...
   friend void init_attrIMSim__SyncPntList();
