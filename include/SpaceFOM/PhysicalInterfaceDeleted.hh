...
#ifndef SPACEFOM_PHYSICAL_INTERFACE_DELETED_HH
#define SPACEFOM_PHYSICAL_INTERFACE_DELETED_HH
...
class PhysicalInterfaceDeleted : public TrickHLA::ObjectDeletedHandler
{
   ...
   friend void init_attrSpaceFOM__PhysicalInterfaceDeleted();
  ...
  private:
   ...
   /*! @brief Copy constructor for PhysicalInterfaceDeleted class.
    *  @details This constructor is private to prevent inadvertent copies. */
   PhysicalInterfaceDeleted( PhysicalInterfaceDeleted const &rhs );
   /*! @brief Assignment operator for PhysicalInterfaceDeleted class.
    *  @details This assignment operator is private to prevent inadvertent copies. */
   PhysicalInterfaceDeleted &operator=( PhysicalInterfaceDeleted const &rhs );
};

} // namespace SpaceFOM

#endif // SPACEFOM_PHYSICAL_INTERFACE_DELETED_HH: Do NOT put anything after this line!
