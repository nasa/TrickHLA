/*!
@file DSES/ExecutionConfiguration.hh
@ingroup DSES
@brief Definition of the TrickHLA DSES Execution Configuration Object (ExCO).
...
@trick_link_dependency{../../source/DSES/ExecutionConfiguration.cpp}
@trick_link_dependency{../../source/DSES/Types.cpp}

@revs_title
@revs_begin
@rev_entry{Dan Dexter, NASA ER7, TrickHLA, June 2016, --, SISO DSES Initialization.}
@rev_entry{Edwin Z. Crues, NASA ER7, TrickHLA, January 2019, --, DSES support and testing.}
@rev_entry{Edwin Z. Crues, NASA ER7, TrickHLA, June 2019, --, Version 3 rewrite.}
@revs_end

*/

#ifndef _DSES_EXECUTION_CONFIGURATION_HH_
#define _DSES_EXECUTION_CONFIGURATION_HH_
...
class ExecutionConfiguration : public TrickHLA::ExecutionConfigurationBase
{
   ...
   friend void init_attrDSES__ExecutionConfiguration();
  ...
  public:
   ...
   /*! @brief Default constructor for the DSES ExecutionConfiguration class. */
   ExecutionConfiguration();
   /*! @brief Pure virtual destructor for the DSES ExecutionConfiguration class. */
   ...
   virtual void set_current_execution_mode( DSES::ExecutionModeEnum mode );
   ...
   virtual void set_next_execution_mode( DSES::ExecutionModeEnum mode );
...
#endif // _DSES_EXECUTION_CONFIGURATION_HH_: Do NOT put anything after this line!
