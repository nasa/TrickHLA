...
@file DIS/Types.hh
@ingroup DIS
@brief Definition of the TrickHLA DIS enumeration types and utilities.
...
@brief Define the TrickHLA DIS execution mode enumeration values.

The ExecutionModeEnum enumeration defines the possible execution mode
state for a DIS compliant federate. These mode states
are important in the execution control process commanded by a Master
federate and followed all other federates participating in a DIS
...
/*!
@enum MTREnum
@brief Define the TrickHLA DIS Mode Transition Request state enumeration values.
 ...
 *  @return DIS execution mode as a printable string.
...
/*! @brief Convert an DIS::ExecutionModeEnum value to a TrickHLA::ExecutionModeEnum value.
 *  @return DIS::ExecutionModeEnum as an equivalent TrickHLA::ExecutionModeEnum value.
 *  @param mode DIS::ExecutionModeEnum value to convert. */
TrickHLA::ExecutionControlEnum to_execution_control_enum( ExecutionModeEnum mode );
/*! @brief Convert a TrickHLA::ExecutionModeEnum value to an DIS::ExecutionModeEnum value.
 *  @return TrickHLA::ExecutionModeEnum as an equivalent DIS::ExecutionModeEnum value.
 ...
 *  @return DIS mode transition request (MTR) as a printable string.
 ...
 *  @return DIS Mode Transition Request (MTR) as a 16 bit integer.
 ...
 *  @return DIS mode transition request (MTR) as enumeration value.
 *  @param mtr_int MTR mode. */
MTREnum mtr_int16_to_enum( int16_t mtr_int );

// DIS::PausePntStateEnum methods
