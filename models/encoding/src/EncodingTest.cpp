...
{
   if ( DebugHandler::show( TrickHLA::DEBUG_LEVEL_2_TRACE, TrickHLA::DEBUG_SRC_HLA_ENCODERS ) ) {
      ostringstream msg1;
      msg1 << "========================================\n"
   ...
   if ( data1.compare( data2, explanation ) ) {
      ...
      if ( DebugHandler::show( TrickHLA::DEBUG_LEVEL_1_TRACE, TrickHLA::DEBUG_SRC_HLA_ENCODERS ) ) {
