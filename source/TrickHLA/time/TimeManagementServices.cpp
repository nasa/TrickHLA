   ...
   double const main_thread_data_cycle_time )
{
   ...
   if ( DebugHandler::show( DEBUG_LEVEL_5_TRACE, DEBUG_SRC_TIME_MGMT_SERVICES ) ) {
...
{
   if ( DebugHandler::show( DEBUG_LEVEL_2_TRACE, DEBUG_SRC_TIME_MGMT_SERVICES ) ) {
   ...
   RTI1516_NAMESPACE::LogicalTime const &time )
{
   ...
   if ( int64_time >= this->requested_time ) {
      ...
      if ( DebugHandler::show( DEBUG_LEVEL_8_TRACE, DEBUG_SRC_TIME_MGMT_SERVICES ) ) {
      ...
      if ( DebugHandler::show( DEBUG_LEVEL_1_TRACE, DEBUG_SRC_TIME_MGMT_SERVICES ) ) {
...
void TimeManagementServices::time_advance_request_to_GALT()
{
   ...
   if ( DebugHandler::show( DEBUG_LEVEL_3_TRACE, DEBUG_SRC_TIME_MGMT_SERVICES ) ) {
...
void TimeManagementServices::perform_time_advance_request()
{
   ...
   if ( DebugHandler::show( DEBUG_LEVEL_4_TRACE, DEBUG_SRC_TIME_MGMT_SERVICES ) ) {
      if ( is_zero_lookahead_time() ) {
