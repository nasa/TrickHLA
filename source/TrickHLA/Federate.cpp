...
void Federate::publish_interaction_class( // cppcheck-suppress [functionStatic]
...
void Federate::unpublish_interaction_class( // cppcheck-suppress [functionStatic]
   RTI1516_NAMESPACE::InteractionClassHandle const &class_handle )
{
   if ( DebugHandler::show( DEBUG_LEVEL_4_TRACE, DEBUG_SOURCE_FEDERATE ) ) {
...
void Federate::send_interaction( // cppcheck-suppress [functionStatic]
   RTI1516_NAMESPACE::InteractionClassHandle const  &class_handle,
 ...
 *  @job_class{scheduled}
 */
bool Federate::is_execution_member() // cppcheck-suppress [functionStatic]
{
   if ( RTI_ambassador.get() != NULL ) {
...
void Federate::request_federation_save_status() // cppcheck-suppress [functionStatic]
{
   if ( DebugHandler::show( DEBUG_LEVEL_3_TRACE, DEBUG_SOURCE_FEDERATE ) ) {
...
void Federate::request_federation_restore_status() // cppcheck-suppress [functionStatic]
{
   if ( DebugHandler::show( DEBUG_LEVEL_3_TRACE, DEBUG_SOURCE_FEDERATE ) ) {
