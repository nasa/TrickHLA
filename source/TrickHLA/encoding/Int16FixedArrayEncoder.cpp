/*!
@file TrickHLA/Int16FixedArrayEncoder.cpp
@ingroup TrickHLA
 ...
 * Int16FixedArrayEncoder construction process.
 * @job_class{initialization}
 */
Int16FixedArrayEncoder::Int16FixedArrayEncoder(
   ...
   : EncoderBase( trick_variable_name,
                  ...
                  r2 )
{
   Int16FixedArrayEncoder::initialize();
}
...
void Int16FixedArrayEncoder::initialize()
{
   if ( ref2 == NULL ) {
