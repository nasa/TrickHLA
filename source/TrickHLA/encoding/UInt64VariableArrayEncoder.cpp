/*!
@file TrickHLA/UInt64VariableArrayEncoder.cpp
@ingroup TrickHLA
 ...
 * UInt64VariableArrayEncoder construction process.
 * @job_class{initialization}
 */
UInt64VariableArrayEncoder::UInt64VariableArrayEncoder(
   ...
   : EncoderBase( trick_variable_name,
                  ...
                  r2 )
{
   UInt64VariableArrayEncoder::initialize();
}
...
void UInt64VariableArrayEncoder::initialize()
{
#if defined( IEEE_1516_2010 )
   ostringstream msg;
   msg << "UInt64VariableArrayEncoder::initialize():" << __LINE__
   ...
   if ( ( rti_encoding != ENCODING_LITTLE_ENDIAN )
      ...
      errmsg << "UInt64VariableArrayEncoder::initialize():" << __LINE__
   ...
   bool const valid_type = ( ( ref2->attr->type == TRICK_UNSIGNED_LONG_LONG ) && ( sizeof( long long ) == sizeof( Integer64 ) ) )
                           || ( ( ref2->attr->type == TRICK_UNSIGNED_LONG ) && ( sizeof( long ) == sizeof( Integer64 ) ) );
   if ( !valid_type ) {
      ostringstream errmsg;
      errmsg << "UInt64VariableArrayEncoder::initialize():" << __LINE__
             ...
             << Utilities::get_trick_type_string( TRICK_UNSIGNED_LONG_LONG )
             << "'.\n";
      DebugHandler::terminate_with_message( errmsg.str() );
      return;
   }
