/*!
@file TrickHLA/UInt32VariableArrayEncoder.cpp
@ingroup TrickHLA
 ...
 * UInt32VariableArrayEncoder construction process.
 * @job_class{initialization}
 */
UInt32VariableArrayEncoder::UInt32VariableArrayEncoder(
...
void UInt32VariableArrayEncoder::initialize()
{
#if defined( IEEE_1516_2010 )
   ostringstream msg;
   msg << "UInt32VariableArrayEncoder::initialize():" << __LINE__
   ...
   if ( ( rti_encoding != ENCODING_LITTLE_ENDIAN )
      ...
      errmsg << "UInt32VariableArrayEncoder::initialize():" << __LINE__
