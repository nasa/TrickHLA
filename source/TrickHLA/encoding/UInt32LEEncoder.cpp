/*!
@file TrickHLA/UInt32LEEncoder.cpp
@ingroup TrickHLA
 ...
 * UInt32LEEncoder construction process.
 * @job_class{initialization}
 */
UInt32LEEncoder::UInt32LEEncoder(
...
void UInt32LEEncoder::initialize()
{
   if ( ref2 == NULL ) {
   ...
   if ( rti_encoding != ENCODING_LITTLE_ENDIAN ) {
      ...
      errmsg << "UInt32LEEncoder::create():" << __LINE__
   ...
   if ( !valid_type ) {
      ostringstream errmsg;
      errmsg << "UInt32LEEncoder::initialize():" << __LINE__
