/*!
@file TrickHLA/Int32BEEncoder.cpp
@ingroup TrickHLA
 ...
 * Int32BEEncoder construction process.
 * @job_class{initialization}
 */
Int32BEEncoder::Int32BEEncoder(
...
void Int32BEEncoder::initialize()
{
   if ( ref2 == NULL ) {
   ...
   if ( rti_encoding != ENCODING_BIG_ENDIAN ) {
      ...
      errmsg << "Int32BEEncoder::create():" << __LINE__
   ...
   if ( !valid_type ) {
      ostringstream errmsg;
      errmsg << "Int32BEEncoder::initialize():" << __LINE__
