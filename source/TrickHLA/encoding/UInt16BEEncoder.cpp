/*!
@file TrickHLA/UInt16BEEncoder.cpp
@ingroup TrickHLA
 ...
 * UInt16BEEncoder construction process.
 * @job_class{initialization}
 */
UInt16BEEncoder::UInt16BEEncoder(
...
void UInt16BEEncoder::initialize()
{
   if ( ref2 == NULL ) {
   ...
   if ( rti_encoding != ENCODING_BIG_ENDIAN ) {
      ...
      errmsg << "UInt16BEEncoder::create():" << __LINE__
   ...
   if ( !valid_type ) {
      ostringstream errmsg;
      errmsg << "UInt16BEEncoder::initialize():" << __LINE__
