/*!
@file TrickHLA/UInt32FixedArrayEncoder.cpp
@ingroup TrickHLA
 ...
 * UInt32FixedArrayEncoder construction process.
 * @job_class{initialization}
 */
UInt32FixedArrayEncoder::UInt32FixedArrayEncoder(
   ...
   : EncoderBase( trick_variable_name,
                  ...
                  r2 )
{
   UInt32FixedArrayEncoder::initialize();
}
