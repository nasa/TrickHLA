/*!
@file TrickHLA/UInt32BEEncoder.cpp
@ingroup TrickHLA
 ...
 * UInt32BEEncoder construction process.
 * @job_class{initialization}
 */
UInt32BEEncoder::UInt32BEEncoder(
...
void UInt32BEEncoder::initialize()
{
   if ( ref2 == NULL ) {
   ...
   if ( rti_encoding != ENCODING_BIG_ENDIAN ) {
      ...
      errmsg << "UInt32BEEncoder::create():" << __LINE__
   ...
   if ( !valid_type ) {
      ostringstream errmsg;
      errmsg << "UInt32BEEncoder::initialize():" << __LINE__
