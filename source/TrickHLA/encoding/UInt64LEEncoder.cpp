/*!
@file TrickHLA/UInt64LEEncoder.cpp
@ingroup TrickHLA
 ...
 * UInt64LEEncoder construction process.
 * @job_class{initialization}
 */
UInt64LEEncoder::UInt64LEEncoder(
...
void UInt64LEEncoder::initialize()
{
   if ( ref2 == NULL ) {
   ...
   if ( rti_encoding != ENCODING_LITTLE_ENDIAN ) {
      ...
      errmsg << "UInt64LEEncoder::create():" << __LINE__
