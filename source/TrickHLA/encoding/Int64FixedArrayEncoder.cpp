/*!
@file TrickHLA/Int64FixedArrayEncoder.cpp
@ingroup TrickHLA
 ...
 * Int64FixedArrayEncoder construction process.
 * @job_class{initialization}
 */
Int64FixedArrayEncoder::Int64FixedArrayEncoder(
   ...
   : EncoderBase( trick_variable_name,
                  ...
                  r2 )
{
   Int64FixedArrayEncoder::initialize();
}
...
void Int64FixedArrayEncoder::initialize()
{
   if ( ref2 == NULL ) {
   ...
   if ( ( rti_encoding != ENCODING_LITTLE_ENDIAN )
      ...
      errmsg << "Int64FixedArrayEncoder::initialize():" << __LINE__
