/*!
@file TrickHLA/Int16BEEncoder.cpp
@ingroup TrickHLA
 ...
 * Int16BEEncoder construction process.
 * @job_class{initialization}
 */
Int16BEEncoder::Int16BEEncoder(
...
void Int16BEEncoder::initialize()
{
   if ( ref2 == NULL ) {
   ...
   if ( rti_encoding != ENCODING_BIG_ENDIAN ) {
      ...
      errmsg << "Int16BEEncoder::create():" << __LINE__
