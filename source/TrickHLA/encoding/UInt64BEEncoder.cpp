/*!
@file TrickHLA/UInt64BEEncoder.cpp
@ingroup TrickHLA
 ...
 * UInt64BEEncoder construction process.
 * @job_class{initialization}
 */
UInt64BEEncoder::UInt64BEEncoder(
...
void UInt64BEEncoder::initialize()
{
   if ( ref2 == NULL ) {
   ...
   if ( rti_encoding != ENCODING_BIG_ENDIAN ) {
      ...
      errmsg << "UInt64BEEncoder::create():" << __LINE__
   ...
   if ( !valid_type ) {
      ostringstream errmsg;
      errmsg << "UInt64BEEncoder::initialize():" << __LINE__
