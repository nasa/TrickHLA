...
@file DSES/Types.cpp
@ingroup DSES
@brief Implementation of the TrickHLA DSES types utility functions.
...
string DSES::execution_mode_enum_to_string(
   ExecutionModeEnum mode )
{
   switch ( mode ) {
      ...
      default:
         return "UNKNOWN DSES Execution Mode";
         break;
   }
...
int16_t DSES::execution_mode_enum_to_int16(
   ExecutionModeEnum mode )
{
...
ExecutionModeEnum DSES::execution_mode_int16_to_enum(
   int16_t int_mode )
{
   switch ( int_mode ) {
...
TrickHLA::ExecutionControlEnum DSES::to_execution_control_enum(
   ExecutionModeEnum mode )
{
   switch ( mode ) {
...
ExecutionModeEnum DSES::from_execution_contorl_enum(
   TrickHLA::ExecutionControlEnum mode )
{
   switch ( mode ) {
      ...
      case TrickHLA::EXECUTION_CONTROL_UNUSED:
         return EXECUTION_MODE_UNINITIALIZED;
         break;
...
string DSES::mtr_enum_to_string(
   MTREnum mtr_enum )
{
...
int16_t DSES::mtr_enum_to_int16(
   MTREnum mtr_enum )
{
...
MTREnum DSES::mtr_int16_to_enum(
   int16_t mtr_int )
{
