...
#
HLA_walls_config( obj_service.objects[0], 'walls_hla', 'walls', walls_hla.packing, True )

#
# Configure the HLA data for each Ball.
#
HLA_ball_config( obj_service.objects[1], 'ball1_hla', ball1.state.name, ball1_hla.packing, True )
HLA_ball_config( obj_service.objects[2], 'ball2_hla', ball2.state.name, ball2_hla.packing, False )
HLA_ball_config( obj_service.objects[3], 'ball3_hla', ball3.state.name, ball3_hla.packing, False )
