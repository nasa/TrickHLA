...
def HLA_ball_config( THLA_object,
   ...
   THLA_object.attributes[0].config          = trick.CONFIG_INITIALIZE_AND_CYCLIC
   ...
   THLA_object.attributes[1].config          = trick.CONFIG_INITIALIZE_AND_CYCLIC
   ...
   THLA_object.attributes[2].config          = trick.CONFIG_INITIALIZE_AND_CYCLIC
   ...
   THLA_object.attributes[3].config          = trick.CONFIG_INITIALIZE_AND_CYCLIC
   ...
   THLA_object.attributes[4].config          = trick.CONFIG_INITIALIZE_AND_CYCLIC
   THLA_object.attributes[4].publish         = publish
   THLA_object.attributes[4].subscribe       = subscribe
   THLA_object.attributes[4].locally_owned   = owns
   ...
   THLA_object.attributes[5].config          = trick.CONFIG_INITIALIZE_AND_CYCLIC
   THLA_object.attributes[5].publish         = publish
   THLA_object.attributes[5].subscribe       = subscribe
   THLA_object.attributes[5].locally_owned   = owns
