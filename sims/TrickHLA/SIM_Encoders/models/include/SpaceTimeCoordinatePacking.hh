/*!
@file SpaceTimeCoordinatePacking.hh
@ingroup SpaceFOM
...
#ifndef SPACEFOM_STC_PACKING_HH
#define SPACEFOM_STC_PACKING_HH
...
class SpaceTimeCoordinatePacking : public TrickHLA::Packing
{
  ...
  private:
   ...
   /*! @brief Copy constructor for SpaceTimeCoordinatePacking class.
    *  @details This constructor is private to prevent inadvertent copies. */
   SpaceTimeCoordinatePacking( SpaceTimeCoordinatePacking const &rhs );
   /*! @brief Assignment operator for SpaceTimeCoordinatePacking class.
    *  @details This assignment operator is private to prevent inadvertent copies. */
   SpaceTimeCoordinatePacking &operator=( SpaceTimeCoordinatePacking const &rhs );
};

} // namespace SpaceFOM

#endif // SPACEFOM_STC_PACKING_HH: Do NOT put anything after this line!
