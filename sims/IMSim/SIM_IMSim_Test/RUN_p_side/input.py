...
THLA.imsim_exec_control.multiphase_init_sync_points = 'Phase1, Phase2'
# Set the simulation timeline to be used for time computations.
THLA.imsim_exec_control.sim_timeline = THLA_INIT.sim_timeline
...
#---------------------------------------------
THLA.imsim_config.owner        = 'P-side-Federate'
THLA.imsim_config.run_duration = run_duration
...
# HLA instance for.
obj_service.objects[0].FOM_name            = 'SineParameters'
...
# publish data for.
obj_service.objects[1].FOM_name            = 'SineParameters'
