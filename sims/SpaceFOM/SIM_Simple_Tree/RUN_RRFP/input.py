...
if not trick_debug:
   ...
   root_ref_frame.frame_packing.publish()
   leaf_ref_frame.frame_packing.publish()

#---------------------------------------------------------------------------
# Set the frames in the simple reference frame tree.
#---------------------------------------------------------------------------
ref_frame_tree.root_frame_data.name = 'Root Frame'
...
ref_frame_tree.leaf_frame_data.name = 'Leaf Frame'
ref_frame_tree.leaf_frame_data.parent_name = 'Root Frame'
