...
federate.add_known_federate( False, 'Other-Federate' )
...
federate.add_multiphase_init_sync_point( 'Analytic_init_phase1' )
federate.add_multiphase_init_sync_point( 'Analytic_init_phase2' )
