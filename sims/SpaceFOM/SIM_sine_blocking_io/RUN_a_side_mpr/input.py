...
AB.sim_data.name = 'AB.sim_data.name.A-side.blocking_io'
PB.sim_data.name = 'PB.sim_data.name.A-side.blocking_io'
...
sine_AB = SineObject( sine_create_object      = True,
...
sine_PB = SineObject( sine_create_object      = False,
