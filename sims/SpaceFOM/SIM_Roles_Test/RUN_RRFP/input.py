...
root_ref_frame.frame_data.state.quat.scalar  = 1.0
root_ref_frame.frame_data.state.quat.vector[0] = 0.0
root_ref_frame.frame_data.state.quat.vector[1] = 0.0
root_ref_frame.frame_data.state.quat.vector[2] = 0.0
